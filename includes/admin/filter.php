...
function wpdbbkp_unsubcribe_email_notification(){
	//phpcs:ignore	WordPress.Security.NonceVerification.Recommended	-- This is user unsubscribe action from email notification.Here unsubscribe_token is doing the job of nonce.
